...
<div class="container">
    <div class="row">
        <div class="col-12">
            ...
            <form method="post" action="{{ route('updateClientNotification',$event->id) }}" class="mt-2">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="client_id" class="form-control" id="client_id" value="{{$event->client_id}}">
                            </div>
                            <div class="mb-3">
                                <label for="businessNumber" class="form-label">Notification Id</label>
                                <input type="text" class="form-control" name="notification_id" id="notification_id" value="{{$event->notification_id}}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="frequency" id="frequency" value="{{$event->frequency_day}}">
                            </div>
